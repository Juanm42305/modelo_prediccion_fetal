...
def index():
    ...
    return render_template("index.html", nombres_campos=nombres_campos, rangos_campos=rangos_campos)
...
def predecir():
    ...
    try:
        entrada = []
        # Campos con selects y sus valores permitidos
        selects_valores = {
        ...
        if modelo_sel == "fcm":
            ...
            return render_template("index.html", error_individual="Modelo no válido",
                                   nombres_campos=nombres_campos, rangos_campos=rangos_campos)

        return render_template("index.html", resultado_individual={'prediccion': pred, 'modelo': modelo_sel},
                               nombres_campos=nombres_campos, rangos_campos=rangos_campos)

    except Exception as e:
        return render_template("index.html", error_individual=str(e),
                               nombres_campos=nombres_campos, rangos_campos=rangos_campos)
